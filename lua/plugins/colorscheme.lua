...
return {
  ...
  config = function(_, opts)
    ...
    local function toggle_transparency()
      ...
      -- Reload the tokyonight theme with updated options
      require('tokyonight').setup(opts)
      vim.cmd('colorscheme tokyonight')

      -- Adjust background color based on transparency
      ...
      -- Notify the user
      print('Transparency ' .. (opts.transparent and 'enabled' or 'disabled'))
    end
